...
const cancelSolicitationClientEmail = (data) => ` 
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8" />
...
<body>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10b es-m-txt-c">
                                                                                        <h1 style="font-size: 34px; line-height: 100%;">Pedido Cancelado!</h1>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
  ...
  data.id
                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p20t es-p10b es-p20r es-p20l" align="left">
                                                        <table width="560" cellpadding="0" cellspacing="0"><tr><td width="280" valign="top">
                                                        <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                                                            <tbody>
                                                                <tr>
  ...
  data.createdAt
                                                        ...
                                                        </td><td width="0"></td><td width="280" valign="top">
                                                        <table cellpadding="0" cellspacing="0" class="es-right" align="right">
                                                            <tbody>
                                                                <tr>
...
const cancelSolicitationAdminEmail = (data) => ` 
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8" />
...
<body>
  ...
  data.client.name
}</strong> foi cancelado!</strong><br/>
                                                                                       <br /> <br />
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
