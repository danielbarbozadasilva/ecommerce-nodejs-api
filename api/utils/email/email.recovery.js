                                                                      ...
                                                                      <tbody>
                                                                          ...
                                                                          <tr>
                                                                              <td align="center" class="esd-block-text es-p15t es-p15b es-p40r es-p40l es-m-p0r es-m-p0l es-m-txt-c" esd-links-underline="none">
                                                                                  <h1 style="font-size: 36px;">Recuperação de Senha</h1>
                                                                              </td>
                                                                          </tr>
                                                                          <tr>
                                                                              <td align="left" class="esd-block-text es-p10t">
                                                                                  <p>&nbsp;<br><br>Aqui está o código para redefinir a sua senha:<strong>${token}</strong><br><br>&nbsp; &nbsp; 1. Insira o código.<br><br>&nbsp; &nbsp; 2. Crie uma nova senha.<br><br>&nbsp; &nbsp; 3. Clique em Confirmar.<br><br></p>
                                                                              </td>
                                                                          </tr>
                                                                      </tbody>
                                                                  </table>
                                                                      ...
                                                                      <tbody>
                                                                          ...
                                                                          <tr>
                                                                              <td align="center" class="esd-block-text es-p35b">
                                                                                  <p>E-commerce © 2022 E-commerce, Inc. All Rights Reserved.</p>
                                                                              </td>
                                                                          </tr>
                                                                      </tbody>
                                                                  </table>
